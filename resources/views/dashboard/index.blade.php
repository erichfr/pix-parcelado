...
<div class="row g-4">
    {{-- Total de Clientes --}}
    <div class="col-md-3">
        <div class="card card-hover shadow-lg text-center p-3" style="background: linear-gradient(135deg,#1a1a2e,#162447); color:white; border-radius:15px;">
            ...
            <a href="{{ route('clients.index') }}" class="btn btn-sm btn-info btn-hover mt-2">
                Ver Clientes
            </a>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card card-hover shadow-lg text-center p-3" style="background: linear-gradient(135deg,#1a1a2e,#162447); color:white; border-radius:15px;">
            ...
            <a href="{{ route('installments.index','pendente') }}" class="btn btn-sm btn-warning btn-hover mt-2">
                Ver Pendentes
            </a>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card card-hover shadow-lg text-center p-3" style="background: linear-gradient(135deg,#1a1a2e,#162447); color:white; border-radius:15px;">
            ...
            <a href="{{ route('installments.index','pago') }}" class="btn btn-sm btn-success btn-hover mt-2">
                Ver Pagas
            </a>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card card-hover shadow-lg text-center p-3" style="background: linear-gradient(135deg,#1a1a2e,#162447); color:white; border-radius:15px;">
            ...
            <a href="{{ route('installments.index','vencido') }}" class="btn btn-sm btn-danger btn-hover mt-2">
                Ver Vencidas
            </a>
        </div>
    </div>
...
{{-- Gráfico de Parcelas --}}
<div class="card card-hover shadow-lg mt-5 p-3" style="background: linear-gradient(135deg,#1a1a2e,#162447); color:white; border-radius:15px;">
...
<div class="row g-4 mt-4">
    <div class="col-md-6">
        <a href="{{ route('clients.index') }}" class="card card-hover shadow-lg p-4 text-center text-white text-decoration-none" style="background: linear-gradient(135deg,#1a1a2e,#162447); border-radius:15px;">
            <h4><i class="bi bi-clock-history me-2"></i> Histórico Completo</h4>
            <p>Visualize todos os pagamentos e parcelas de cada cliente.</p>
        </a>
    </div>
    <div class="col-md-6">
        <a href="{{ route('payments.create') }}" class="card card-hover shadow-lg p-4 text-center text-white text-decoration-none" style="background: linear-gradient(135deg,#1a1a2e,#162447); border-radius:15px;">
